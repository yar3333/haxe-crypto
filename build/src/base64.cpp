...
static value crypto_base64_encode(value v)
{
	BIO *b64, *bmem;
	BUF_MEM *bptr;
...
DEFINE_PRIM(crypto_base64_encode, 1);

static value crypto_base64_decode(value v)
{
	BIO *b64, *bmem;
...
DEFINE_PRIM(crypto_base64_decode, 1);
